    ...
    >
      <div className="mx-auto flex max-w-md items-center justify-between px-4 py-2 lg:max-w-[1400px] lg:px-6 lg:py-3">
        ...
        <Link
          ...
          aria-label="السلة"
          dir="rtl"
          className="relative flex flex-row-reverse items-center gap-2 rounded-md bg-primary/10 px-2.5 py-1.5 ring-1 ring-primary/15 transition hover:bg-primary/15 ease-apple shadow-soft lg:hidden"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-sm bg-primary text-primary-foreground shadow-pill">
